...
class Detail_data44Controller extends Controller
{
    // view
    public function detailData44()
    {
        if (Auth::check()) {
            $role = Auth::user()->role;
        } else {
    ...
    public function createDataProses44(Request $request)
    {
        ...
        return redirect('/detailData44');
    }

    // update data
    public function updateData44()
    {
    ...
    public function updateDataProses44(Request $request)
    {
        ...
        return redirect('/detailData44')->with('success','update data success');
    }
}
